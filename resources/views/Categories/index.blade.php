...
<div class="p-8 bg-gray-50 min-h-screen">
    <div class="flex items-center justify-between mb-6">
        ...
        <a href="/categories/create" class="px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-lg shadow-sm transition-all">
    + Add New Category
</a>
    </div>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4 text-right space-x-2">
                        <a href="/categories/edit/{{$category->id}}" class="text-sm font-medium text-indigo-600 hover:text-indigo-900">Edit</a>
                        <a href="/categories/delete/{{$category->id}}" class="text-sm font-medium text-red-600 hover:text-red-900">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
